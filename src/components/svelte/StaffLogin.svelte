  ...
  <div class="bg-white rounded-2xl border border-gray-100 p-8 shadow-lg">
    ...
    <form onsubmit={handleSubmit} class="space-y-4">
      ...
      <div class="relative">
        ...
        <button type="button" onclick={() => showPw = !showPw} class="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-lg hover:bg-gray-100 transition-colors text-gray-400">
          {#if showPw}
