  ...
  {#if showInvite}
    <div class="bg-gray-50 rounded-xl p-4 mb-4 space-y-3">
      ...
      <div class="relative">
        ...
        <button type="button" onclick={() => showInvitePw = !showInvitePw} class="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-lg hover:bg-gray-100 transition-colors text-gray-400">
          {#if showInvitePw}
