  ...
  {#if showInvite}
    <div class="bg-gray-50 rounded-xl p-4 mb-4 space-y-3">
      ...
      <div class="relative">
        ...
        <button type="button" onclick={() => showInvitePw = !showInvitePw} class="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-blue-600 hover:text-blue-800 font-medium bg-white px-2 py-1 rounded border border-gray-200">
          {showInvitePw ? 'Nascondi' : 'Mostra'}
        </button>
      </div>
